...
define Device/avm_fritz3370
  ...
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-ath9k wpad-basic-wolfssl kmod-usb-dwc2 fritz-tffs
endef
...
define Device/avm_fritz3390
  ...
  KERNEL_SIZE := 4096k
  IMAGE_SIZE := 49152k
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-ath9k kmod-owl-loader wpad-basic-wolfssl \
...
define Device/avm_fritz7360sl
  ...
  IMAGE_SIZE := 15744k
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-ath9k kmod-owl-loader wpad-basic-wolfssl kmod-usb-dwc2
...
define Device/avm_fritz7362sl
  ...
  KERNEL_SIZE := 4096k
  IMAGE_SIZE := 49152k
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-ath9k kmod-owl-loader wpad-basic-wolfssl kmod-usb-dwc2 fritz-tffs
endef
...
define Device/avm_fritz7412
  ...
  KERNEL_SIZE := 4096k
  IMAGE_SIZE := 49152k
  DEVICE_PACKAGES := xrx200-phy22f-firmware kmod-ath9k kmod-owl-loader wpad-basic-wolfssl fritz-tffs-nand fritz-caldata
endef
...
define Device/bt_homehub-v5a
  ...
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-ath9k kmod-owl-loader \
...
define Device/buffalo_wbmr-300hpd
  ...
  IMAGE_SIZE := 15616k
  DEVICE_PACKAGES := xrx200-phy22f-firmware kmod-mt7603 wpad-basic-wolfssl kmod-usb-dwc2
...
define Device/lantiq_easy80920-nand
  ...
  DEVICE_VARIANT := NAND
  IMAGE_SIZE := 64512k
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-ath9k kmod-owl-loader wpad-basic-wolfssl kmod-usb-dwc2 kmod-usb-ledtrig-usbport
endef
...
define Device/zyxel_p-2812hnu-f1
  ...
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-rt2800-pci wpad-basic-wolfssl kmod-usb-dwc2 kmod-usb-ledtrig-usbport
  KERNEL_SIZE := 3072k
...
define Device/zyxel_p-2812hnu-f3
  ...
  DEVICE_PACKAGES := xrx200-phy11g-firmware kmod-rt2800-pci wpad-basic-wolfssl kmod-usb-dwc2
